...
const changeThemeInCSS = (theme) => {
    if (theme === "dark"){
        document.documentElement.style.setProperty("--primary-color", "#675750")
        document.documentElement.style.setProperty("--secondary-color", "#5a5447")
        ...
        document.documentElement.style.setProperty("--primary-text-color", "#b1b1b1")
